...
<form action="./update" method="post">
	<input type="hidden" value="${dto.num}" name = "num"><!-- 여기서 오류 발생했음... num을 지정을 안해줬음 -->
	<table class="table table-bordered" style="width:400px;">
		...
		<tr>
			...
			<td width="200" colspan="2">
				...
				placeholder="xxx-xxxx-xxxx" value="${dto.hp }"><!-- 010-0000-0000패턴으로 넣어라 -->
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="3" align="center">
				<button type="submit" class="btn btn-outline-danger" style="width:150px;">회원 정보 수정</button>
			</td>
		</tr>
	</table>
</form>
