...
<link href="https://fonts.googleapis.com/css2?family=Caveat:wght@400..700&family=Dancing+Script:wght@400..700&family=East+Sea+Dokdo&family=Jua&family=Gaegu&family=Gamja+Flower&family=Pacifico&family=Single+Day&display=swap" rel="stylesheet">
   ...
   <style>
   	...
   	$(function(){
   	    ...
   	    //아이디 수정시 다시 중복확인을 누르도록 중복변수를 초기화
   	    $("#myid").keyup(function(){
   	    	jungbok = false;
   	    });
   	});		//close function
...
<body>
<!-- <h1>입력 폼</h1> -->
<form action="./insert" method="post" enctype="multipart/form-data" onsubmit="return check()"><!-- onsubmit하기 전에 check()먼저하겠다. -->
	<table class="table table-bordered" style="width:400px;">
		...
		<tr>
			...
			<td rowspan="2">
				...
				<!-- spring에서 resource는 springboot에서는 static!!!. 현재 위치에서 부모디렉토리로 올라가서, image폴더로 들어가서 noimage1.png 불러오기 -->
			</td>
		</tr>
		<tr>
			<th width="100" class="table-info">비밀번호<br>두번 확인 만들어보기</th>
			<td width="200">
