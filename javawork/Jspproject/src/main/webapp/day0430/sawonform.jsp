		...
		<form action="./sawoninsert.jsp" method="post">
			<table class="table table-bordered">
				...
				<tr>
					...
					<td>
						<input type="number" name="age" class="form-control" required="required" min="1" max="100" step="1" value="0"><!-- 초기값은 0 -->
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<img alt="" src="" class="photo" onerror="this.src='../image/noimage1.png'">
				...
				<tr>
					...
					<td>
						<input type="date" class="form-control" name="birthday" value="2024-04-30">										
					</td>
				</tr>
				<tr>
					<td colspan="2" align="center">
						<button type="submit" class="btn btn-outline-secondary btn-sm" style="width: 80px;">사원저장</button>
