...
<body>
	<div style="margin: 10px; width: 500px;">
		<h2>
			<b>상품명 : <%=dto.getSname()%></b>
		</h2>
		<span style="font-size: 14px; color: gray;"> 등록일 : <%=sdf.format(dto.getWriteday())%>
		</span>

		<table>
			<tr>
				<td width="300"><img alt="" src="<%=dto.getSphoto() %>"
					style="border: 10px groove orange; margin: 10px; width: 270px;">
				</td>
				<td>
					<h5>가격 : <%=dto.getSprice() %>원</h5>
					<h5 style="border: black solid 1px; background-color:<%=dto.getScolor()%>">색상 : <%=dto.getScolor() %></h5>
