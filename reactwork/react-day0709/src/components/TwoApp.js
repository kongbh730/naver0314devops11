...
const TwoApp = () => {
    ...
    return (
        <div>
            <h3 className='alert alert-danger'>TwoApp-image를 불러오는 또 다른 방법</h3>
            <h5>import를 이용해서 이미지 가져오기</h5>
            <img alt="photo1" src={photo1} style={{width:'100px'}}></img>

            <h5>require를 이용해서 이미지 가져오기</h5>
            <img alt="photo2" src={require(`../image/19.jpg`)} style={{width:'100px'}}></img>
            <hr></hr>
            ...
            <br></br>
            <img alt="photo" src={require(`../image/${photo}.jpg`)}
            style={{width:'200px', marginLeft:'100px'}}></img>
